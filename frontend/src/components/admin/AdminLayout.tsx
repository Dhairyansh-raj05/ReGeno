...
const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-[#0D0D0D] overflow-hidden font-display text-white selection:bg-[#B000FF]/30">
      <aside className="w-64 bg-[#111111] border-r border-white/5 flex-col hidden md:flex z-10 shrink-0">
        ...
        <div className="p-4 border-t border-white/5">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-red-500/10 text-red-500 hover:bg-red-500/20 border border-red-500/10 rounded-xl font-bold transition-all"
          >
